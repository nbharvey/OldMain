...
>
  ...
  <section className="max-w-5xl mx-auto px-4 py-10 my-4 text-center bg-brandSilver rounded-lg shadow-md">
    <h2 className="text-3xl font-bold mb-4">From upscale to easygoing, Old Main Restaurant + Bar is where Crete gathers. Come for the food, stay for the feeling. </h2>
    <p className="mb-2">
